...
@NamedQuery(
    name = "LkReportTemplateStatus.findAll",
    query = "SELECT l FROM LkReportTemplateStatus l")
public class LkReportTemplateStatus implements LkGeneric, Serializable {
  ...
  /** Instantiates a new lk report template status. */
