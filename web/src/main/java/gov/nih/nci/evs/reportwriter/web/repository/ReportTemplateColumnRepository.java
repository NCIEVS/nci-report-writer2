...
public interface ReportTemplateColumnRepository
    extends CrudRepository<ReportTemplateColumn, Integer> {

  List<ReportTemplateColumn> getReportColumnsByReportTemplateId(
