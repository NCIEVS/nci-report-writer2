...
import gov.nih.nci.evs.reportwriter.core.util.JSONUtils;
import gov.nih.nci.evs.reportwriter.core.util.ParserUtils;
import gov.nih.nci.evs.reportwriter.core.util.RESTUtils;
import gov.nih.nci.evs.reportwriter.core.util.SortUtils;
import jakarta.annotation.PostConstruct;

@Service
/**
 * Contains methods for executing SPARQL queries and converting the results into Class instances.
 */
public class SparqlQueryManagerServiceImpl implements SparqlQueryManagerService {
  ...
  public void postInit() {
    restUtils =
        new RESTUtils(
            ...
            graphdbProperties.getReadTimeout(),
            graphdbProperties.getConnectTimeout());
  }
   ...
   * @return List of EvsConcept instances.
   */
  public List<EvsConcept> getEvsSuperclasses(
      String conceptCode, String namedGraph, String restURL) {
   ...
   * @return List of EvsConcept instances.
   */
  public List<EvsConcept> getEvsConceptInSubset(
      String conceptCode, String namedGraph, String restURL) {
  ...
  public List<EvsConcept> getAssociatedEvsConcepts(
      String conceptCode, String namedGraph, String restURL, String associationName) {
  ...
  public List<EvsConcept> getAssociatedEvsConcepts(
    ...
    String queryPrefix = queryBuilderService.contructPrefix();
    String query =
        queryBuilderService.construct_associated_concept_query(
            namedGraph, associationName, conceptCode, sourceOf);
   ...
   * @return EvsConcept instance.
   */
  public EvsConcept getEvsConceptDetailShort(
      String conceptCode, String namedGraph, String restURL) {
    EvsConcept evsConcept = new EvsConcept();
    List<EvsProperty> properties = getEvsProperties(conceptCode, namedGraph, restURL);
  ...
  public List<EvsAssociation> getEvsAssociations(
      String namedGraph, String restURL, String associationName, boolean sourceOf) {
    String queryPrefix = queryBuilderService.contructPrefix();
    String query =
        queryBuilderService.construct_get_associated_concepts(
            namedGraph, associationName, sourceOf);
    String res = restUtils.runSPARQL(queryPrefix + "\n" + query, restURL);
    ObjectMapper mapper = new ObjectMapper();
    mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
  ...
  public List<EvsSupportedAssociation> getEvsSupportedAssociations(
      String namedGraph, String restURL) {
    String queryPrefix = queryBuilderService.contructPrefix();
    String query = queryBuilderService.constructSupportedAssociationQuery(namedGraph);
    String res = restUtils.runSPARQL(queryPrefix + "\n" + query, restURL);
    ObjectMapper mapper = new ObjectMapper();
    mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
    ArrayList<EvsSupportedAssociation> evsSupportedAssociations =
        new ArrayList<EvsSupportedAssociation>();
    try {
      Sparql sparqlResult = mapper.readValue(res, Sparql.class);
      Bindings[] bindings = sparqlResult.getResults().getBindings();
      for (Bindings b : bindings) {
  ...
  public List<String> getConceptsInSubset(String named_graph, String code, String restURL) {
    ...
    String query =
        queryBuilderService.construct_get_concepts_in_subset(named_graph, code, code_only);
    String json = restUtils.runSPARQL(queryPrefix + "\n" + query, restURL);
    Vector v = new JSONUtils().parseJSON(json);
    v = new ParserUtils().getResponseValues(v);
    v = new SortUtils().quickSort(v);
  ...
  public List<String> getSubsetMemberConceptData(
      String named_graph, String subset_code, String restURL) {
    String queryPrefix = queryBuilderService.contructPrefix();
    boolean code_only = true;
    String query =
        queryBuilderService.construct_get_subset_member_concept_data(named_graph, subset_code);
    String json = restUtils.runSPARQL(queryPrefix + "\n" + query, restURL);
    Vector v = new JSONUtils().parseJSON(json);
    v = new ParserUtils().getResponseValues(v);
    v = new SortUtils().quickSort(v);
  ...
  public List<String> getMatchedAnnotatedTarget(
      String named_graph,
      String code,
      String propertyName,
      Vector qualifierNames,
      Vector qualifierValues,
      String restURL) {
    String queryPrefix = queryBuilderService.contructPrefix();
    String query =
        queryBuilderService.construct_get_matched_annotated_target(
            named_graph, code, propertyName, qualifierNames, qualifierValues);
    String json = restUtils.runSPARQL(queryPrefix + "\n" + query, restURL);
    Vector v = new JSONUtils().parseJSON(json);
    v = new ParserUtils().getResponseValues(v);
    v = new SortUtils().quickSort(v);
  ...
  public List<String> getRoleTargets(
      String named_graph, String code, String roleName, String restURL) {
    String queryPrefix = queryBuilderService.contructPrefix();
  ...
  public List<String> getAssociationTargets(
      String named_graph, String code, String associationName, String restURL) {
    String queryPrefix = queryBuilderService.contructPrefix();
    String query =
        queryBuilderService.construct_get_association_targets(named_graph, code, associationName);
    String json = restUtils.runSPARQL(queryPrefix + "\n" + query, restURL);
    return parseJSON(json);
  }
