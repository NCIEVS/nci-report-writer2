...
public class SpecialReportWriter extends ReportWriter {
  ...
  public String runSpecialReport(
      String templateFile,
      String outputFile,
      String conceptFile,
      String restURL,
  ...
  public Vector process_subset(
      Template template, String restURL, String namedGraph, String subset_code, String expansible) {
    Vector v = new Vector();
    List<String> list =
        sparqlQueryManagerService.getSubsetCconceptData(namedGraph, subset_code, restURL);
    ...
    while (it.hasNext()) {
      ...
      s =
          parse_member_concept_data(
              template, namedGraph, member_concept_code, member_concept_data, restURL);
      v.add(s);
    }
    return v;
  }

  public String parse_member_concept_data(
      Template template, String namedGraph, String code, Vector v, String restURL) {
    /*
    0 ?x_label
    1 ?x_code
    2 ?p_label
    ...
    */
    ...
    if (cdisc_pt_knt > 1) {
      ...
      list =
          sparqlQueryManagerService.getMatchedAnnotatedTarget(
              namedGraph, subset_code, propertyName, qualifierNames, qualifierValues, restURL);
