...
/** The Class ReportTemplateServiceImpl. */
@Service
public class ReportTemplateServiceImpl implements ReportTemplateService {
  ...
  /** The report template repository. */
  @Autowired ReportTemplateRepository reportTemplateRepository;
  ...
  public ReportTemplateUI create(ReportTemplateUI reportTemplate) {
    ...
    for (ReportTemplateColumn reportTemplateColumn : reportTemplateColumns) {
      ...
      ReportTemplateColumn reportTemplateColumnRet =
          reportTemplateColumnRepository.save(reportTemplateColumn);

      log.info(
          "reportTemplateColumnRet "
              + reportTemplateColumnRet.getId()
              + " - "
  ...
  public ReportTemplateUI save(ReportTemplateUI reportTemplate) {
    ...
    ReportTemplate reportTemplatedb =
        reportTemplateRepository.findById(reportTemplate.getId()).orElse(null);
    reportTemplatedb.setLevel(reportTemplate.getLevel());
    reportTemplatedb.setName(reportTemplate.getName());
    reportTemplatedb.setRootConceptCode(reportTemplate.getRootConceptCode());
    reportTemplatedb.setType(reportTemplate.getType());
    ...
    ReportTemplate reportTemplateRet =
        reportTemplateRepository.findById(reportTemplate.getId()).orElse(null);
  ...
  public ReportTemplateUI clone(ReportTemplateUI reportTemplate) {
    ReportTemplate oldReportTemplate =
        reportTemplateRepository.findById(reportTemplate.getId()).orElse(null);
    ...
    ReportTemplate newReportTemplatedb =
        reportTemplateRepository.findById(newReportTemplateRet.getId()).orElse(null);
