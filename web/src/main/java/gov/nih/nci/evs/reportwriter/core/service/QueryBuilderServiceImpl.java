...
public class QueryBuilderServiceImpl implements QueryBuilderService {
  ...
  public String construct_associated_concept_query(
      String namedGraph, String associationName, String code) {
  ...
  */
  ...
  public String construct_associated_concept_query(
      String namedGraph, String associationName, String code, boolean sourceOf) {
    StringBuffer buf = new StringBuffer();
    if (sourceOf) {
    ...
    if (sourceOf) {
      ...
      buf.append(
              "            ?x :NHC0 \"" + code + "\"^^<http://www.w3.org/2001/XMLSchema#string> .")
          .append("\n");
    }
    ...
    buf.append("            ?y rdfs:range ?y_range").append("\n");
    buf.append("    }").append("\n");
    buf.append("    FILTER (str(?y_range)=\"http://www.w3.org/2001/XMLSchema#anyURI\")")
        .append("\n");
    buf.append("}").append("\n");
    return buf.toString();
  }

  public String construct_get_associated_concepts(
      String namedGraph, String association, boolean sourceOf) {
    StringBuffer buf = new StringBuffer();
    if (sourceOf) {
      buf.append("SELECT distinct ?sourceName ?sourceCode ?associationName ?targetName ?targetCode")
          .append("\n");
    } else {
      buf.append("SELECT distinct ?targetName ?targetCode ?associationName ?sourceName ?sourceCode")
          .append("\n");
    }
    buf.append("{").append("\n");
    buf.append("    graph <" + namedGraph + ">").append("\n");
  ...
  public String constructSupportedAssociationQuery(String namedGraph) {
    StringBuffer query = new StringBuffer();
    query
        .append("SELECT distinct ?supportedAssociationName ?supportedAssociationCode")
        .append("\n");
    query.append("{").append("\n");
    ...
    query.append("  }").append("\n");
    query
        .append("  FILTER (str(?x_range)=\"http://www.w3.org/2001/XMLSchema#anyURI\")")
        .append("\n");
    query.append("}").append("\n");
    return query.toString();
  }
  ...
  public String construct_get_concepts_in_subset(
      String named_graph, String code, boolean code_only) {
    StringBuffer buf = new StringBuffer();
    if (code_only) {
  ...
  public String construct_get_subset_member_concept_data(String named_graph, String subset_code) {
    StringBuffer buf = new StringBuffer();
    buf.append(
            "select distinct ?x_label ?x_code ?p_label ?p_value ?a_prop_label ?a_target ?q1_label ?q1_value ?q2_label ?q2_value ?b_target ?b_prop_label ?q5_value ?r_label ?r_code ?q3_label ?q3_value ")
        .append("\n");
    buf.append("from <" + named_graph + ">").append("\n");
    buf.append("").append("\n");
    buf.append("where  {").append("\n");
  ...
  public String construct_get_matched_annotated_target(
      String named_graph,
      String code,
      String propertyName,
    ...
    for (int i = 0; i < qualifierNames.size(); i++) {
      ...
      buf.append("                ?a ?q" + j + " \"" + qualifierValue + "\"^^xsd:string .")
          .append("\n");
      buf.append("                ?q" + j + " rdfs:label ?q" + j + "_label .").append("\n");
      buf.append("                ?q" + j + " rdfs:label \"" + qualifierName + "\"^^xsd:string .")
          .append("\n");
    }
    buf.append("}").append("\n");
    return buf.toString();
  ...
  public String construct_get_subset_concept_data(String named_graph, String code) {
    StringBuffer buf = new StringBuffer();
    buf.append(
            "select distinct ?p1_value ?x_label ?a_target ?q1_label ?q1_value ?q2_label ?q2_value ?b_prop_label ?b_target ?p2_label ?p2_value")
        .append("\n");
    buf.append("from <" + named_graph + ">").append("\n");
    buf.append("where  {").append("\n");
    buf.append("                ?x a owl:Class .").append("\n");
  ...
  public String construct_get_role_targets(String named_graph, String code, String roleName) {
    ...
    buf.append("            ?y (rdfs:subClassOf|(owl:intersectionOf/rdf:rest*/rdf:first))* ?r1 .")
        .append("\n");
    ...
    buf.append("").append("\n");
    buf.append("            ?x owl:equivalentClass ?y .").append("\n");
    buf.append("            ?y (rdfs:subClassOf|(owl:unionOf/rdf:rest*/rdf:first))* ?r1 .")
        .append("\n");
    buf.append("            ?r1 owl:onProperty ?p .").append("\n");
    buf.append("").append("\n");
    buf.append("            ?p :NHC0 ?p_code .").append("\n");
  ...
  public String construct_get_association_targets(
      String named_graph, String code, String associationName) {
    StringBuffer buf = new StringBuffer();
