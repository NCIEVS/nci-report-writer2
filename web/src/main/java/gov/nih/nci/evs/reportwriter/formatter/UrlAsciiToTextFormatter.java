 ...
 * @version 1.0
 */
public class UrlAsciiToTextFormatter extends AsciiToTextFormatter implements FormatterConstant {
  private static final Logger _logger = LoggerFactory.getLogger(UrlAsciiToTextFormatter.class);
